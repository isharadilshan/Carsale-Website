            ...
            <div class="section services">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/hatchback.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>HatchBack</h5>
                            <ul>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/sedan.jpg" alt="images" class="img-responsive"><h6>
                            </div>
                            <h5>Sedan</h5>
                            <ul>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/mpv.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>MPV</h5>
                            <ul>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/suv.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>SUV</h5>
                            <ul>
                                <li>Conventionally, a sports utility vehicle (SUV) is a big car built on a body-on-frame chassis, sports increased ground clearance and offers off-roading capabilities to a certain extent. With that said, the aforementioned definition of an SUV has blurred over time and often includes both off-roaders and soft-roaders</li>
                            </ul>
                        </div><!-- category-avt -->	
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/crossover.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>Crossover</h5>
                            <ul>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/coupe.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>Coupe</h5>
                            <ul>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/convertible.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>Convertible</h5>
                            <ul>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="category-avt">
                            <div class="category-icon">
                                <h6><img src="images/categories/sports.jpg" alt="images" class="img-responsive"></h6>
                            </div>
                            <h5>Sports</h5>
                            <ul>
